...
bool L1ExactPenaltyRestoPDFSpaceSolver::Solve(Number alpha,
                                              Number beta,
...
{
    DBG_START_METH("L1ExactPenaltyRestoPDFSpaceSolver::Solve", dbg_verbosity);
...
void L1ExactPenaltyRestoPDFSpaceSolver::ComputeResiduals(const SymMatrix &W,
                                                         const Matrix &J_c,
                                                         const Matrix &J_d,
                                                         const Matrix &Px_L,
                                                         const Matrix &Px_U,
...
{
    DBG_START_METH("L1ExactPenaltyRestoPDFSpaceSolver::ComputeResiduals", dbg_verbosity);
    ...
    Pd_U.MultVector(s_fact, *res.v_U(), 0., *resid.s_NonConst());
    Pd_L.MultVector(-s_fact, *res.v_L(), 1., *resid.s_NonConst());
